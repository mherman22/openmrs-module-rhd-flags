...
until that page is saved again. On platform 2.4.0 to 2.4.3 and 2.5.0, core applies the entry to
`org.openmrs` even after a restart, which the module cannot prevent.
